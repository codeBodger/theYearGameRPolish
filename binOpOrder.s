...
binOpOrd3h:
    ...
    // 132, same as 231
        ...
        // get unaries, sign
        GET_UNARIES binOpOrd3h_132_end
        GET_SIGN
        ...
        // save a: no need, used immediately
        // get 1: no need, and false because not saved
        // get 2
        mov p1i, bo2b

        // get binary
        GET_BINARY binOpOrd3h_132_end
        ...
        // save 3: no need, used immediately, but move to p1i
        mov p1i, r0i

        // get 1
        mov p0i, bo1b

        // get 3: no need, and false because not saved
        ...
        // update val, score, arrs
        UPDATE_VALUE_SCORE_ARRS binOpOrd3h_132_end
    ...
    // 213
        ...
        // get unaries, sign
        GET_UNARIES binOpOrd3h_213_end
        GET_SIGN
        ...
        // update val, score, arrs
        UPDATE_VALUE_SCORE_ARRS binOpOrd3h_213_end
    ...
    // 312
        ...
        // get unaries, sign
        GET_UNARIES binOpOrd3h_312_end
        GET_SIGN
        ...
        // get binary
        GET_BINARY binOpOrd3h_312_end

        // get unaries, sign
        GET_UNARIES binOpOrd3h_312_end
        GET_SIGN

        // save 2: no need, used immediately
        // get 4
        mov p1i, bo4b
        ...
        // update val, score, arrs
        UPDATE_VALUE_SCORE_ARRS binOpOrd3h_312_end
    ...
    // 321
        ...
        // get unaries, sign
        GET_UNARIES binOpOrd3h_321_end
        GET_SIGN
        ...
        // save c: no need, used immediately
        // get 3: no need, and false because not saved
        // get 4
        mov p1i, bo4b

        // get binary
        GET_BINARY binOpOrd3h_321_end
        ...
        // update val, score, arrs
        UPDATE_VALUE_SCORE_ARRS binOpOrd3h_321_end
